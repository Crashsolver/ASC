...
def set_defaults(self):
    ...
    self.defaultState.set(gv.set_tmp[3])
    ...
    self.minute_select_combo.set(gv.set_tmp[5])
    ...
    self.hour_select_combo.set(gv.set_tmp[6])
    ...
    self.dom_select_combo.set(gv.set_tmp[7])
    ...
    self.month_select_combo.set(gv.month_reverse_dict[gv.set_tmp[8]])
    ...
    self.dow_select_combo.set(gv.dow_reverse_dict[gv.set_tmp[9]])
...
def save_settings(self):
    ...
    tmp_sql = ""
    for item in gv.settings_field_list:
        tmp_sql += item+'= ?, '
    tmp_sql = tmp_sql[:-2]
